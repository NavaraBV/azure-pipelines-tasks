...
tr.setInput('useProvisioningProfilesFromProject', 'true');
...
let a: ma.TaskLibAnswers = <ma.TaskLibAnswers> {
  ...
  "exec": {
    ...
    "/home/bin/xcodebuild -sdk $(SDK) -configuration $(Configuration) -workspace /user/build/fun.xcodeproj/project.xcworkspace -scheme fun build CODE_SIGN_STYLE=Manual": {
      "code": 0,
      "stdout": "xcodebuild output here"
    },
